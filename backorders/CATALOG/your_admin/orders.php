...
<!--Added for Backorders PRO-Webs.net-->
<td class="dataTableHeadingContent">Date Available</td>
<!--eof backorders-->
...
// Added for Backorders PRO-Webs.net
           '            <td class="dataTableContent" valign="top">' . zen_date_short(zen_products_lookup($order->products[$i]['id'], 'products_date_available')) . '</td>' . "\n" .
// eof backorders
